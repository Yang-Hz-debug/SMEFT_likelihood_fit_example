...
def createCards():
    ...
    bkg_procs = {
        ...
        # 'Zmm' : ['TT','VJet','VV', 'ZH_hbb'],
        # 'Zee' : ['TT','VJet','VV', 'ZH_hbb'],
    ...
    sig_procs = {
        # 'Zmm' : ['ZH_hcc'],
        # 'Zee' : ['ZH_hcc'],
        'Zmm' : ['ZZ_bb', 'ZZ_cc', 'WZ_bb', 'WZ_cc'],
        'Zee' : ['ZZ_bb', 'ZZ_cc', 'WZ_bb', 'WZ_cc'],
        'Wmn' : ['WH_hcc'],
        'Wen' : ['WH_hcc'],
        'Znn' : ['ZH_hcc']
    }
    ...
    cats = {
        'Zmm' : [
            # (1, 'Zmm_cc_SR'), (3, 'Zmm_CR_HF'), (5, 'Zmm_CR_cc_LF'), (7, 'Zmm_CR_TT'), (9, 'Zmm_CR_CC')
            (1, 'Zmm_cc_SR'), (2, 'Zmm_bb_SR'), (3, 'Zmm_CR_B'), (4, 'Zmm_CR_HF_left'), (5, 'Zmm_CR_LF'), (7, 'Zmm_CR_TT'), (8, 'Zmm_CR_BB'), (9, 'Zmm_CR_CC')
            # (1, 'Zmm_bb_SR'), (2, 'Zmm_cc_SR'), (3, 'Zmm_CR_B'), (5, 'Zmm_CR_BB'), (6, 'Zmm_CR_LF'), (7, 'Zmm_CR_TT'), (9, 'Zmm_CR_CC')
        ],
        'Zee' : [
            # (1, 'Zee_cc_SR'), (3, 'Zee_CR_HF'), (5, 'Zee_CR_cc_LF'), (7, 'Zee_CR_TT'), (9, 'Zee_CR_CC')
            (1, 'Zee_cc_SR'), (2, 'Zee_bb_SR'), (3, 'Zee_CR_B'), (4, 'Zee_CR_HF_left'), (5, 'Zee_CR_LF'), (7, 'Zee_CR_TT'), (8, 'Zee_CR_BB'), (9, 'Zee_CR_CC')
            # (1, 'Zee_bb_SR'), (2, 'Zee_cc_SR'), (3, 'Zee_CR_B'), (5, 'Zee_CR_BB'), (6, 'Zee_CR_LF'), (7, 'Zee_CR_TT'), (9, 'Zee_CR_CC')
        ],
        'Wmn' : [
    ...
    writer=ch.CardWriter("output_Hcc/" + args.output_folder + "_" + year + "/$TAG/$BIN_"+year+".txt",
                         "output_Hcc/" + args.output_folder + "_" + year +"/$TAG/shapes/shapes_$BIN_"+year+".root")
