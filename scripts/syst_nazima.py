...
#                  (['ZH','ZH_hcc','ZH_SMEFT'], 1.016)
#                  (['WH_hbb','WH_hcc'], 1.019))
#
#  cb.cp().process(['ggZH','ggZH_hcc']).AddSyst(cb,'pdf_Higgs_gg', 'lnN', ch.SystMap()(1.024))
#  cb.cp().process(['ggZH','ggZH_hcc']).AddSyst(cb,'QCDscale_ggZH', 'lnN',ch.SystMap()((1.251,0.811)))
#
#  cb.cp().AddSyst(cb,'QCDscale_VH', 'lnN', ch.SystMap('process')
#                  (['ZH','ZH_hcc', 'ZH_SMEFT'], (1.038,0.969))
#                  (['WH_hbb','WH_hcc'], (1.005,0.993)))
#
#
#  cb.cp().process(['ZH_hcc','WH_hcc','ggZH_hcc']).AddSyst(cb,'BR_hcc', 'lnN', ch.SystMap()((1.05,0.97)))
  cb.cp().process(['ZH_bb','WH_hbb','ggZH', 'ZH_SMEFT']).AddSyst(cb,'BR_hbb', 'lnN', ch.SystMap()(1.005))
...
#                  (['Zee','Zmm'],['ZH_hcc','ggZH_hcc','ZH','ggZH', 'ZH_SMEFT'], 1.02)
#                  (['Znn'],['ZH_hcc','WH_hcc','ggZH_hcc','ZH','WH_hbb','ggZH'],1.02)
...
#
  ...
  #cb.cp().process(['ST']).AddSyst(cb,'CMS_vhbb_ST', 'lnN', ch.SystMap()(1.15))
  ...
  #cb.cp().process(['ggZH','ggZH_hcc']).AddSyst(cb,'CMS_LHE_pdf_ggZH', 'lnN', ch.SystMap()(1.023))
  #cb.cp().process(['ZH','ZH_hcc', 'ZH_SMEFT']).AddSyst(cb,'CMS_LHE_pdf_ZH', 'lnN', ch.SystMap()(1.018))
  ...
  cb.cp().AddSyst(cb,'AK4PFPuppi_JER','shape',ch.SystMap()(1.0))
  cb.cp().AddSyst(cb,'AK4PFPuppi_JES_Total','shape',ch.SystMap()(1.0))
#[Auto] Using variations from MC sample 'ggZH_Hto2B_Zto2L__incl': ['AK4PFPuppi_JERDown', 'AK4PFPuppi_JERUp', 'AK4PFPuppi_JES_TotalDown', 'AK4PFPuppi_JES_TotalUp',
 #'AK8PFPuppi_JERDown', 'AK8PFPuppi_JERUp', 'AK8PFPuppi_JES_TotalDown', 'AK8PFPuppi_JES_TotalUp', 'nominal',
 # 'pileupDown', 'pileupUp',
 #'sf_ele_diele_triggerDown', 'sf_ele_diele_triggerUp', 
 #'sf_ele_idDown', 'sf_ele_idUp', 'sf_ele_recoDown', 'sf_ele_recoUp', 'sf_mu_idDown', 'sf_mu_idUp', 'sf_mu_isoDown', 'sf_mu_isoUp',
 #'sf_partonshower_fsrDown', 'sf_partonshower_fsrUp', 'sf_partonshower_isrDown', 'sf_partonshower_isrUp']
...
#  cb.cp().AddSyst(cb, 'sf_dimu_trigger', 'shape', ch.SystMap()(1.0))
...
#                                                      ([1,3,5,7,9],1.0))
  ...
  print(f"[INFO] Added btag systematics with BTV Run3 scheme for {year} ({'decorrelated' if decorrelate_btag else 'correlated'})")